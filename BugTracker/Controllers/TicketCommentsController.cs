...
namespace BugTracker.Controllers
{
    public class TicketCommentsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,CommentBody,TicketId,UserId")] TicketComment ticketComment)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,CommentBody,TicketId,UserId")] TicketComment ticketComment)
        {
            if (ModelState.IsValid)
            {
